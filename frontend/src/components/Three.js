...
const Three = () => {
    ...
    useEffect(() => {
        const general = async () => {
            try {
                ...
                const response = await fetch(`https://itesm-project2-backend.herokuapp.com/all_movies`);
    ...
    function createChart(){
        ...
        let svgWidth = window.innerWidth*2/3;
        let svgHeight = window.innerWidth/2;
        ...
        <div>
            <div className="container">
                <div className="row p-3">
                    <div className='col'>
                        <h2 className="display-6 pt-3 pb-3">Find your favorite movie based on country, genre and language!</h2>
                        <p className="lead">Quick review</p>
                        <p>Select the contry, language of your choice, based on that we will show you the 20 best rated movies, and display grafically their duration, rating, and year of release!</p>
                    </div>
                    <hr className='mt-4 mb-4'/>
                    <div className="col">
                        <h1 className='text-center'>A unique color, for a unique movie...</h1>
                    </div>
                </div>
                <div className="row">
                    <div className="col-md-4">
                        <div className="dropdown">
                            ...
                            <div id="myDropdown1" className="dropdown-content" style={{height: "200px", overflow: "auto"}}>
                    ...
                    <div className="col-md-4">
                        <div className="dropdown" style={{"text-align": "center"}}>
                            ...
                            <div id="myDropdown2" className="dropdown-content" style={{height: "200px", overflow: "auto"}}>
                    ...
                    <div className="col-md-4">
                        <div className="dropdown" style={{"text-align": "center"}}>
                            ...
                            <div id="myDropdown3" className="dropdown-content" style={{height: "200px", overflow: "auto"}}>
